...
@Composable
fun ClosedSourceNotice(listing: Listing, modifier: Modifier = Modifier) {
    if (listing != Listing.CLOSED_SOURCE) return
    ...
    Surface(
        ...
        Row(
            ...
            Text(
                text = stringResource(R.string.details_closed_source_notice),
